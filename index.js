...
/////////////////
const BotName = 'NICKYAN BOT☄'; 
const instagram = 'https://instagram.com/dnickz_'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@dnickz_')
